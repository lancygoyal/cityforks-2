Template.home.onCreated(function() {
  ...
  this.bottomRight = new ReactiveVar;
  this.markers = {};
  ...
  this.setBounds = function(bounds) {
    ...
    if (bounds) {
      ...
      this.bottomRight.set([bounds._northEast.lng, bounds._northEast.lat]);
    }
  }

  var template = this;
  template.autorun(function() {
    template.subscribe('nearbyPlaces', template.bottomLeft.get(), template.bottomRight.get());
  });
});
